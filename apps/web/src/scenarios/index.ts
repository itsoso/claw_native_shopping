    ...
    "replenish-laundry",
    {
      ...
      outcomes: {
        time_saving: {
          ...
          sellerLabel: "晨光农场直营网",
          priceLabel: "30 元",
          etaLabel: "明早 09:00 前送达",
          comparisonLabel: "已比较 2 个可履约卖家",
        },
        safe: {
          ...
          sellerLabel: "可追溯家庭蛋仓",
          priceLabel: "28 元",
          etaLabel: "明天上午 10:00 前送达",
          comparisonLabel: "优先保留履约评分更高的卖家",
        },
        value: {
          ...
          sellerLabel: "家庭高频补货仓",
          priceLabel: "27 元",
          etaLabel: "明天下午 16:00 前送达",
          comparisonLabel: "保留更便宜选项，但不会牺牲默认偏好",
        },
      },
      steps: {
    ...
    "optimize-cart-threshold",
    {
      ...
      outcomes: {
        time_saving: {
          ...
          note: "默认只走办公室白名单卖家。",
          sellerLabel: "办公补货白名单仓",
          priceLabel: "96 元",
          etaLabel: "明早 10:00 前送达",
          comparisonLabel: "已合并 2 项低风险耗材",
        },
        safe: {
          itemLabel: "商用咖啡豆 1kg",
          ...
          sellerLabel: "行政默认供应商",
          priceLabel: "68 元",
          etaLabel: "明天中午 12:00 前送达",
          comparisonLabel: "异常价格会被自动抬升成人工复核",
        },
        value: {
          ...
          sellerLabel: "阈值凑单优选仓",
          priceLabel: "88 元",
          etaLabel: "明天下午 15:00 前送达",
          comparisonLabel: "优先把采购收敛成一单完成",
        },
      },
      steps: {
    ...
    "seller-eta-tradeoff",
    {
      ...
      outcomes: {
        time_saving: {
          ...
          sellerLabel: "冷链优先履约仓",
          priceLabel: "28 元",
          etaLabel: "今天 12:00 前送达",
          comparisonLabel: "已比较 2 个冷链卖家报价",
        },
        safe: {
          itemLabel: "冷链鲜牛奶 950ml",
          ...
          priceLabel: "26 元",
          etaLabel: "今天 12:00 前送达",
          comparisonLabel: "优先保留冷链履约评分更高的卖家",
        },
        value: {
          itemLabel: "冷链鲜牛奶 950ml",
